cmd_board/calixto/am335x_versa_nxt512/board.o := arm-linux-gnueabihf-gcc -Wp,-MD,board/calixto/am335x_versa_nxt512/.board.o.d -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabihf/11/include -Iinclude      -I./arch/arm/include -include ./include/linux/kconfig.h -I./dts/upstream/include  -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=./= -gdwarf-4 -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -mgeneral-regs-only -pipe -D__LINUX_ARM_ARCH__=7 -mtune=generic-armv7-a -I./arch/arm/mach-omap2/include    -DKBUILD_BASENAME='"board"'  -DKBUILD_MODNAME='"board"' -c -o board/calixto/am335x_versa_nxt512/board.o board/calixto/am335x_versa_nxt512/board.c

source_board/calixto/am335x_versa_nxt512/board.o := board/calixto/am335x_versa_nxt512/board.c

deps_board/calixto/am335x_versa_nxt512/board.o := \
    $(wildcard include/config/dm/serial.h) \
    $(wildcard include/config/skip/lowlevel/init.h) \
    $(wildcard include/config/ddr512.h) \
    $(wildcard include/config/ddr256.h) \
...
board/calixto/am335x_versa_nxt512/board.o: $(deps_board/calixto/am335x_versa_nxt512/board.o)
