	...
	.file	"asm-offsets.c"
@ GNU C11 (GCC) version 13.4.0 (arm-oe-linux-gnueabi)
@	compiled by GNU C version 13.4.0, GMP version 6.3.0, MPFR version 4.2.1, MPC version 1.3.1, isl version none
...
.ascii "->GD_FLAGS #32 offsetof(struct global_data, flags)"	@
@ 0 "" 2
	.loc 1 36 2 view .LVU6
@ 36 "lib/asm-offsets.c" 1
	
.ascii "->GD_MALLOC_BASE #204 offsetof(struct global_data, malloc_base)"	@
@ 0 "" 2
...
.ascii "->GD_RELOC_OFF #60 offsetof(struct global_data, reloc_off)"	@
@ 0 "" 2
	.loc 1 43 2 view .LVU9
@ 43 "lib/asm-offsets.c" 1
	
.ascii "->GD_START_ADDR_SP #56 offsetof(struct global_data, start_addr_sp)"	@
@ 0 "" 2
	.loc 1 45 2 view .LVU10
@ 45 "lib/asm-offsets.c" 1
	
.ascii "->GD_NEW_GD #4 offsetof(struct global_data, new_gd)"	@
@ 0 "" 2
...
.LASF5:
	.ascii	"long int\000"
.LASF11:
	.ascii	"GNU C11 13.4.0 -mthumb -mthumb-interwork -mabi=aapc"
...
.LASF8:
	.ascii	"short int\000"
.LASF13:
	.ascii	"/media/drive_a/am335/am335_u-boot/calixto-ti-u-boot"
	.ascii	"-upgrade-test1\000"
